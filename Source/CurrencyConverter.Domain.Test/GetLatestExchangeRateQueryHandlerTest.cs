...
namespace CurrencyConverter.Domain.Test
{
    ...
    public sealed class GetLatestExchangeRateQueryHandlerTest
    {
        ...
        [Test]
        public async Task Handle_Always_Calls_GetCurrencyRateAsync_Once()
        {
            // arrange
            var queryRequest = new GetLatestExchangeRateQuery("USD")
            {
                Context = new SessionContext(string.Empty)
            };
            var mockMapper = ObjectFactory.CreateMockMapper();
            var mockMemoryCache = ObjectFactory.CreateMemoryCache();
            ...
            Mock.Get(mockServiceManagerContext.FrankfurterService)
                .Setup(o => o.GetLatestExchangeRateAsync(
            ...
            var target = new GetLatestExchangeRateQueryHandler(mockMapper, mockServiceManagerContext, mockMemoryCache);
            ...
            Mock.Get(mockServiceManagerContext.FrankfurterService)
                .Verify(
                    o => o.GetLatestExchangeRateAsync(
                        It.Is<ISessionContext>(ctxt => ReferenceEquals(ctxt, queryRequest.Context)),
                        It.IsAny<string>()), Times.Once);
        }

        [Test]
        public async Task Handle_Always_Calls_GetCurrencyRate_Entity_To_Dto_Mapper_Once()
        {
            // arrange
            var queryRequest = new GetLatestExchangeRateQuery("USD")
            {
        ...
        [Test]
        public async Task Handle_Always_GetCurrencyRate_Returns_HandlerResponse()
        {
            // arrange
            var queryRequest = new GetLatestExchangeRateQuery("USD")
            {
